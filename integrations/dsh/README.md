...
![Automatic-memory activity](./figures/reme-status-auto-memory.png)
...
![ReMe Status overview](./figures/reme-status-overview.png)
...
![ReMe Status Auto Memory](./figures/reme-status-auto-memory.png)
...
![ReMe Status Components](./figures/reme-status-components.png)
...
![ReMe Status Journal](./figures/reme-status-journal.png)
...
![ReMe Status Personal Knowledge Base](./figures/reme-status-knowledge.png)
