...
![ReMe 状态总览](./figures/reme-status-overview.png)
...
![ReMe 状态自动记忆](./figures/reme-status-auto-memory.png)
...
![ReMe 状态组件](./figures/reme-status-components.png)
...
![ReMe 状态日记](./figures/reme-status-journal.png)
