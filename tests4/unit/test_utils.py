"""Tests for small utilities in ``reme4.utils``."""
...
def test_mock_reme_server_uses_reme4_entrypoint(monkeypatch):
    """The test server helper should spawn the reme4 CLI module, not legacy reme."""
    ...
    assert captured["cmd"][:4] == [sys.executable, "-m", "reme4.reme", "start"]
