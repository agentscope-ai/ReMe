...
from reme_ai.core.schema import Message, ToolCall, ToolAttr
...
def get_messages_with_reasoning() -> List[Message]:
    ...
    return [
        ...
        Message(
            ...
            reasoning_content="Let me think about this step by step. 2 + 2 equals 4 because addition combines two quantities.",
        ),
    ]
...
Examples:
  ...
  python test_token_counter.py --all         # Test all token counters
    ...
    if not counters_to_test:
        ...
        counters_to_test = [(BaseTokenCounter, "BaseTokenCounter", {})]
        print("No counter specified, defaulting to BaseTokenCounter")
        print("Use --all to test all counters, or --base/--openai/--hf to test specific ones\n")
