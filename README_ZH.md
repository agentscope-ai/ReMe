...
ReMe 是一个**模块化的记忆管理工具包**，为 AI 智能体提供统一的记忆能力，提供基于文件系统和基于向量DataBase的记忆系统。
...
> Memory as File System, File System as Memory, 基于文件的记忆系统，让 AI 拥有**持久化记忆**能力——就像人类用笔记本记录重要事项一样。
