...
| `context_check` | 📏 检查上下文是否超限 | [ContextChecker](reme/memory/cli/fb_context_checker.py)                                                                                                                                                                   |
| `compact`       | 📦 压缩历史对话为摘要 | [Compactor](reme/memory/cli/fb_compactor.py)                                                                                                                                                                              |
| `summary`       | 📝 将重要记忆写入文件 | [Summarizer](reme/memory/cli/fb_summarizer.py)                                                                                                                                                                            |
...
[Summarizer](reme/memory/cli/fb_summarizer.py) 是记忆总结的核心组件，它采用 **ReAct + 文件工具** 模式。
...
当对话过长时，[Compactor](reme/memory/cli/fb_compactor.py) 负责将历史对话压缩为精华摘要——就像写**会议纪要**
，把冗长的讨论浓缩成关键要点。
