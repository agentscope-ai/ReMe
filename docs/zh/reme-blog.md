...
在未来的beta版本中，上层 Agent将会 通过 Proactive 读取这个主题后，可以选择在合适的时机追问：“要不要把最近讨论过的检索问题整理成一份评测方案？”也可以据此启动一个经过用户授权的资料收集流程。不需要用户思考并显示指定自己的兴趣关键词与范围，与会话中潜在体现需求相关的外部资料也会源源不断进入知识库。
